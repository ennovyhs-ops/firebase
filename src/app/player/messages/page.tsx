...
export default function MessagesPage() {
    const [conversations, setConversations] = useState(allConversations.filter(c => c.recipient.toString().toLowerCase().includes("player") || c.recipient.toString().toLowerCase().includes("everyone")));
